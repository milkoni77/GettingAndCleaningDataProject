...
========================================================================
Columns of the features list are factored. According to the description above and the features.txt file, their column appearance in x_test and x_train datasets is the same as their rowID in features.txt. 
So, features dataset uses three columns:
